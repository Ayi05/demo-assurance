            ...
            <div>
              <div className="border rounded px-4 my-4">
                ...
                <div className="form-group row justify-content-start">
                  ...
                  <div className="col">
                    <select className="form-control" name="genre" onChange={event => { this.setState({ genre: event.target.value }) }}>
                      {genres.map(genre => (
                  ...
                  <div className="col">
                    <TextField size="small" label="Prénom" name="prenom" variant="outlined" onChange={event => { this.setState({ prenom: event.target.value }) }} />
                  </div>

                  <div className="col">
                    <TextField size="small" label="Nom" variant="outlined" name="nom" onChange={event => { this.setState({ nom: event.target.value }) }} />
                  </div>
                </div>
                ...
                <div className="form-group row justify-content-start">
                  ...
                  <div className="col-4">
                    <TextField size="small" label="Code Postal" name="cp" variant="outlined" placeholder="A1B C2D" onChange={event => { this.setState({ cp: event.target.value }) }} />
                  </div>

                  <div className="col-4">
                    <TextField size="small" label="Téléphone" name="tel" variant="outlined" placeholder="(123)-456-7890" onChange={event => { this.setState({ tel: event.target.value }) }} />
                  </div>
